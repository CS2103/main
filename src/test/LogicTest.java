...
public class LogicTest {
	...
	private static String[] command1 = {"add have dinner with James from 1200 to 1300",
									   "add buy flower for Sherry",
									   "add write report by 10/11",
									   "add hand in CS2013 report by tmr",
									   "add CS2103 tutorial from 1000 to 1100 weekly",
									   "add take MRT to Jurong by 1800",
									   "mark 1",
									   "del 2"};
	private static String[] command2 = {"edit 1 time from 1200 tmr to 1300 tmr",
										"show tmr",
										"m 1",
										"undo"};
