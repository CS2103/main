...
public class ParserTest {
	...
	public static final String EDIT_TEST_2 = new String("e 6 start 10.12.15");
	...
	public static final String ADD_INCONSISTENT_CASE_TEST_1 = new String("cReAtE Buy An apPle frOm 21.5 1245 to 13:52 15-6");
	public static final String ADD_INCONSISTENT_CASE_TEST_2 = new String("AdD SHOPPING from 10.12.15 to 14/5/12");

	public static final String ADD_WHITESPACE_CASE_TEST_1 = new String("     add task title 123 from 10 nov 15 to 12 nov 15");
	public static final String ADD_WHITESPACE_CASE_TEST_2 = new String("add    task title456 from 10 nov 14 to 11 nov 14");
	public static final String ADD_WHITESPACE_CASE_TEST_3 = new String("add task title456 from     10 nov 14 to    11 nov 14");
	public static final String ADD_WHITESPACE_CASE_TEST_4 = new String("add task title456 from 10     nov 14 to 11 nov     14");
