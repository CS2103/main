...
public class Constants {
	...
	public static String[] dateRegex = {
			...
			"(3[0-1]|2[0-9]|(1[0-9])|(0?)[1-9])[.|/|-]((1[0-2]|(0?)[1-9]))", // 10.12 OR
																		// 10/12
	...
	public static final String[] TASK_START_DATETIME = { "(\\s|^)from (\\d|(t((oday?)|(dy?)|(mr?)|(omorrow))))",
			"(\\s|^)on (\\d|(t((oday?)|(dy?)|(mr?)|(omorrow))))", "(\\s|^)between (\\d|(t((oday?)|(dy?)|(mr?)|(omorrow))))" };
	public static final String[] TASK_END_DATETIME = { "(\\s|^)by (\\d|(t((oday?)|(dy?)|(mr?)|(omorrow))))",
			"(\\s|^)until (\\d|(t((oday?)|(dy?)|(mr?)|(omorrow))))", "(\\s|^)till (\\d|(t((oday?)|(dy?)|(mr?)|(omorrow))))",
			"(\\s|^)before (\\d|(t((oday?)|(dy?)|(mr?)|(omorrow))))", "(\\s|^)to (\\d|(t((oday?)|(dy?)|(mr?)|(omorrow))))" };
